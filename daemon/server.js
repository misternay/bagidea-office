...
<media-capability>
ถ้าต้องการให้เจ้าของ "เห็น/ดู/ฟัง" รูปภาพ วิดีโอ หรือเสียง — ให้พิมพ์ path เต็ม (absolute)
ของไฟล์นั้นในบรรทัดของมันเอง ออฟฟิศจะแสดงให้เป็นรูป/เครื่องเล่นวิดีโอ/เครื่องเล่นเสียง
ในแชทอัตโนมัติ (มีปุ่มเปิดโฟลเดอร์/เปิดหน้าต่างให้ด้วย). อย่าบอกแค่ "ไฟล์อยู่ที่..." หรือ
แปะลิงก์ดาวน์โหลด — ส่ง path จริงไปเลย. ไฟล์ต้องอยู่ในโฟลเดอร์โปรเจคที่ทำงานอยู่ หรือใน
workspace (ถ้าอยู่ที่อื่น ก๊อปมาที่ workspace/uploads ก่อน).
รองรับ: .png .jpg .jpeg .gif .webp .mp4 .webm .mp3 .wav .m4a .ogg
</media-capability>`;
  child.stdin.write(preamble + prompt + (canSplit ? SUB_NOTE : "") + VOICE_NOTE + MEDIA_NOTE + projectNote());
  child.stdin.end();
