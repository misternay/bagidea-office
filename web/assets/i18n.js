...
const I18N = {
  en: {
    ...
    f_brain_t:"Swappable brains", f_brain_d:"Run each agent on its own model — Claude/GLM/DeepSeek/Qwen/MiniMax direct, or OpenAI/Gemini/OpenRouter/NVIDIA and custom providers via a built-in zero-dependency proxy (no LiteLLM). Plus auto-compact + auto-new-thread for every model, so long chats never clog or freeze.",
    ...
    d_brain_direct:"<b>Direct (Anthropic-compatible):</b> Claude · GLM (Z.AI) · DeepSeek · Qwen (Alibaba) · MiniMax",
    d_brain_proxy:"<b>Via the built-in proxy (OpenAI-compatible):</b> OpenAI · Gemini · OpenRouter · NVIDIA build",
  ...
  th: {
    ...
    f_brain_t:"สมองสลับได้", f_brain_d:"ให้ agent แต่ละตัวใช้คนละโมเดล — Claude/GLM/DeepSeek/Qwen/MiniMax ต่อตรง หรือ OpenAI/Gemini/OpenRouter/NVIDIA และ custom provider ผ่าน proxy ในตัว (ไม่ต้องลง LiteLLM) · พร้อม auto-compact + เปิด thread ใหม่อัตโนมัติทุกโมเดล คุยยาวแค่ไหนก็ไม่ตันไม่ค้าง",
    ...
    d_brain_direct:"<b>ต่อตรง (Anthropic-compatible):</b> Claude · GLM (Z.AI) · DeepSeek · Qwen (Alibaba) · MiniMax",
    d_brain_proxy:"<b>ผ่าน proxy ในตัว (OpenAI-compatible):</b> OpenAI · Gemini · OpenRouter · NVIDIA build",
