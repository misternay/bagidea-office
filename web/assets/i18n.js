...
const I18N = {
  en: {
    ...
    d_wf_2:"<b>Analyze.</b> The Director returns a plan: needed skills/tools, permissions/agents to set up, and open questions. (This release plans only — it doesn't auto-run yet.)",
    d_wf_3:"<b>Save & reuse.</b> Workflows are stored under workspace/workflows. Three example workflows ship in the box to learn from.",
  ...
  th: {
    ...
    d_wf_2:"<b>กดวิเคราะห์</b> Director ตอบกลับเป็นแผน: skill/tool ที่ต้องใช้, permission/agent ที่ต้องเตรียม, และคำถามที่ค้าง (เวอร์ชันนี้วางแผนอย่างเดียว ยังไม่รันเอง)",
    d_wf_3:"<b>บันทึก & ใช้ซ้ำ</b> workflow เก็บใน workspace/workflows มีตัวอย่าง 3 ชุดให้เรียนรู้ในตัว",
